...
function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      console.log(this.state); // const posts = this.state.products.map((product, index)=>{
      //   return (
      //     <div>
      //         <p>{product.name}</p>
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        __self: this
      }, "Click to See all Products"), posts);
    }
  }]);
...
/******/ });
//# sourceMappingURL=Search-3e75307e41c3118407e9.js.map